package com.wjf.moduleimgloader.transformation
 ...
 * 能指定圆角
 */
class RoundedSpecifyCorners constructor(
    private val radius: Int, margin: Int, cornerType: CornerType = CornerType.ALL) : BitmapTransformation() {
    ...
    override fun equals(o: Any?): Boolean {
        return o is RoundedSpecifyCorners && o.radius == radius && o.diameter == diameter && o.margin == margin && o.cornerType == cornerType
    }
    ...
    companion object {
        ...
        private const val ID = "com.wjf.moduleimgloader.transformation.RoundedCorners.$VERSION"
    }
